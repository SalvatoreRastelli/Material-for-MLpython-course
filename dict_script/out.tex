...
{name={pseudoinverse},
	description={\gls{randomexperiment}, \gls{randomexperiment}. The \index{pseudoinverse}Moore–Penrose pseudoinverse $\mA^{+}$ 
...
{name={random experiment},
	description={\gls{pseudoinverse} \gls{pseudoinverse} A random experiment\index{random experiment} is a physical (or abstract) process 
